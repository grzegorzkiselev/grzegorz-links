...
for (let i = 1; i <= document.querySelectorAll(".menu__item").length; i++) {
    // console.log(document.querySelectorAll(".menu__item").length)
    // image = Object.entries(require(`../../static/img/${i}.jpg`))
    image = Object.entries(require(`../../static/img/${i}.png`))
    images.push(image[0])
}
...
export default class MenuItem {
    ...
    render() {
        ...
        this.animatableProperties.tx.current = Math.abs(mousepos.x) - this.bounds.reveal.width / 2;
            // - this.bounds.el.left
        // this.animatableProperties.ty.current = mousepos.y - this.bounds.el.height * 2;
        this.animatableProperties.ty.current = Math.abs(mousepos.y) - this.bounds.reveal.height;
        // this.animatableProperties.ty.current = this.bounds.el.top - this.bounds.reveal.height + this.bounds.el.height * 2
            // this.bounds.el.top + this.DOM.el.scrollTop + (this.bounds.reveal.height / 2)
            // + this.bounds.reveal.height - this.bounds.el.height
            // mousepos.y
            // - this.bounds.reveal.height
        // console.log(mousepos.y)
        // console.log("list")
        // console.log(this.DOM.el.scrollTop)
        // console.log("this.bounds.el.top: " + this.bounds.el.top)
        // console.log("this.bounds.reveal.height: " + this.bounds.reveal.height)
        // console.log(this.bounds.reveal.height / 2)
        // console.log(this.animatableProperties.ty.current)
        ...
        // console.log("this.bounds.el.top: " + this.bounds.el.top);
        // console.log("this.bounds.reveal.height: " + this.bounds.reveal.height);
        // console.log("this.animatableProperties.ty.current: " + this.animatableProperties.ty.current);
        // new rotation value
        ...
        gsap.set(this.DOM.reveal, {
            ...
            filter: `blur(${(this.animatableProperties.brightness.previous - 1) * 10 }px`
